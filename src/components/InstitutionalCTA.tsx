...
export const InstitutionalCTA: React.FC = () => {
  return (
    <section className="py-20 lg:py-28 bg-gradient-to-b from-[#081828] via-[#0B1D30] to-[#061321] text-[#F5F3EF] relative overflow-hidden">
      {/* Subtle luxury borders */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="relative p-8 sm:p-12 lg:p-16 rounded-sm bg-gradient-to-r from-[#061321] via-[#0B1D30] to-[#081828] border border-[#C79A52]/40 shadow-2xl shadow-black/80">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-8 space-y-5 text-left">
              ...
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-normal text-[#F5F3EF] leading-tight">
              ...
              <div className="flex flex-wrap items-center gap-y-2 gap-x-6 text-xs text-[#8E9CAE] pt-2">
            ...
            <div className="lg:col-span-4 flex flex-col items-start lg:items-end justify-center">
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-5 rounded-sm bg-gradient-to-r from-[#C79A52] via-[#D1A75B] to-[#B98A43] text-[#061321] text-sm uppercase tracking-[0.16em] font-bold shadow-xl shadow-[#C79A52]/20 transition-all duration-300 hover:brightness-110 active:scale-[0.98] group"
              >
                <MessageSquare className="w-5 h-5 text-[#061321]" />
                <span>Conversar pelo WhatsApp</span>
              </a>
              <span className="text-[11px] text-[#8E9CAE] mt-3 text-center lg:text-right w-full">
